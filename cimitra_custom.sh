...
CUSTOM_INSTALL_NAME="Innovative Global Technology Group (IGTG)"

# CUSTOM_ADMIN
# CUSTOM_ADMIN_ACCOUNT_CHANGE_ENABLED_IN=1
# CUSTOM_ADMIN_ACCOUNT_ID_IN="admin@cimitra.com"

# CUSTOM LINKS
CUSTOM_LINK_ONE_NAME="Contact IGTG"
CUSTOM_LINK_ONE_DESCRIPTION="We Want to Hear From You"
CUSTOM_LINK_ONE_ADDRESS="http://igtg.net/contact/"
...
# YAML Files
DOCKER_COMPOSE_YML_FILE="https://raw.githubusercontent.com/cimitrasoftware/integrate-igtg/master/docker-compose.yml"
DOCKER_COMPOSE_YML_444_FILE="https://raw.githubusercontent.com/cimitrasoftware/integrate-igtg/master/docker-compose-444.yml"

# BRANDING IMAGE FILES
PNG_FILE_IN="https://raw.githubusercontent.com/cimitrasoftware/integrate-igtg/master/igtg.png"

SVG_FILE_IN="https://raw.githubusercontent.com/cimitrasoftware/integrate-igtg/master/igtg.svg"

SVG_FILE_OUT="igtg.svg"

PNG_FILE_OUT="igtg.png"
...
{
echo ""
echo "Thank You for Installing IGTG/Cimitra"
echo ""
}